			...
			if (cookie.value) {
				switch (cookie.name) {
				  case "brunch_version":
					...
					break;
				  case "latest_stable":
					document.getElementById("latest-stable").innerHTML = '<b>Stable Brunch:</b><br>'+cookie.value+'<br>=> <a href="https://github.com/guylamar2006/brunch/releases/latest" target="_blank">Changelog</a>';
				  ...
				  case "latest_unstable":
					document.getElementById("latest-unstable").innerHTML = '<b>Unstable Brunch:</b><br>'+cookie.value+'<br>=> <a href="https://github.com/guylamar2006/brunch-unstable/releases/latest" target="_blank">Changelog</a>';
